...
2. Download the [fingerproxy binary](https://github.com/subscan-explorer/fingerproxy/releases) and run.
    ```bash
...
Kubernetes liveness probe support is available since [v0.3.0](https://github.com/subscan-explorer/fingerproxy/releases/tag/v0.3.0). Example:
